<section data-w-id="e0a8f063-0a46-3e02-55a6-47cb858b0e29" class="rt-home-v1-hero rt-position-relative">
        ...
        <div data-w-id="e0a8f063-0a46-3e02-55a6-47cb858b0e2b" class="w-layout-hflex rt-productivity">
          ...
          <div class="w-layout-vflex rt-productivity-text-wrapper">
            <div class="w-layout-vflex rt-productivity-text">
              <h1 data-w-id="e0a8f063-0a46-3e02-55a6-47cb858b0e38" class="rt-gap-off rt-h1-gap" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                Elevate Productivity with Future-Ready AI Applications
              </h1>
              <p data-w-id="e0a8f063-0a46-3e02-55a6-47cb858b0e3a" class="rt-productivity-paragraph rt-gap-off rt-h2-paragraph-gap" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                Lorem ipsum dolor sit amet consectetur. Amet ullamcorper atsit
                eros risus eget tristique diam imperdiet. Eleifend
              </p>
            </div>
            <div data-w-id="e0a8f063-0a46-3e02-55a6-47cb858b0e3c" class="w-layout-hflex rt-button-wrapper" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
              ...
              <div class="w-layout-hflex rt-video-block">
                <a href="#" data-w-id="a7f1de74-f930-2a44-f77e-3357e0074c1d" class="rt-hero-video-button-block w-inline-block w-lightbox" aria-label="open lightbox" aria-haspopup="dialog"><div data-w-id="a7f1de74-f930-2a44-f77e-3357e0074c1e" class="w-layout-hflex rt-hero-video-button-icon rt-overflow-hidden" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    <img width="15" height="17" alt="Play button" src="https://wubflow-shield.NOCODEXPORT.DEV/67a1ea8462c51e3f81e40a7e/67dcf931bfc626df83f9d83c_Play%20button.svg" loading="lazy">
                  </div>
                  <div class="w-layout-vflex rt-video-button-text-wrap">
                    <div data-w-id="a7f1de74-f930-2a44-f77e-3357e0074c21" class="rt-button-text rt-button-hover-in" style="transform: translate3d(0px, 0%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                      Watch video
                    </div>
                    <div data-w-id="a7f1de74-f930-2a44-f77e-3357e0074c23" class="rt-button-text rt-button-hover-out" style="transform: translate3d(0px, 100%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                      Watch video
                    </div>
                  </div>
            ...
            <div data-w-id="e0a8f063-0a46-3e02-55a6-47cb858b0e47" class="w-layout-hflex rt-rating-block" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
              <div class="w-layout-hflex rt-rating-image-block rt-overflow-hidden">
                <img width="58" height="58" alt="User" src="https://wubflow-shield.NOCODEXPORT.DEV/67a1ea8462c51e3f81e40a7e/67dcf9270ce1a503421d3681_Users.webp" loading="eager" class="rt-user-image"><img width="58" height="58" alt="Users" src="https://wubflow-shield.NOCODEXPORT.DEV/67a1ea8462c51e3f81e40a7e/67dcf627abf34dbb0271d78e_Users%202.webp" loading="eager" class="rt-user-image rt-left-slide"><img width="58" height="58" alt="Users" src="https://wubflow-shield.NOCODEXPORT.DEV/67a1ea8462c51e3f81e40a7e/67dcf627abf34dbb0271d78f_Users%203.webp" loading="eager" class="rt-user-image rt-left-slide">
              </div>
              <div>
                <div class="w-layout-hflex rt-rating-top-block">
                  <img width="92" height="14" alt="Star" src="https://wubflow-shield.NOCODEXPORT.DEV/67a1ea8462c51e3f81e40a7e/67dcf627abf34dbb0271d793_Star.svg" loading="lazy">
                  <div>4.9/5</div>
                </div>
                <div class="rt-text-style-h6">AI Performance Rating</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="w-layout-blockcontainer rt-container-small w-container">
        <div class="rt-achievement-counter-wrapper">
          <div data-wf--rt-counter-v1--variant="base" class="w-layout-grid rt-our-achievement-v1">
            <div class="w-layout-vflex rt-achievement-box">
              <div data-w-id="73eb367f-86c6-0ebc-de7f-236ac5f86f86" class="w-layout-hflex rt-counter rt-overflow-hidden">
                <div class="w-layout-vflex rt-counter-block rt-margin">
                  <div class="w-layout-vflex rt-counter-train" style="transform: translate3d(0px, -100%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
              ...
              <div class="rt-text-style-h5 counter-color-chnage">
                New Features
              </div>
            </div>
            <div class="w-layout-vflex rt-achievement-box rt-border-remove-tab">
              <div data-w-id="73eb367f-86c6-0ebc-de7f-236ac5f86fab" class="w-layout-hflex rt-counter rt-overflow-hidden">
                <div class="w-layout-vflex rt-counter-block rt-margin">
                  <div class="w-layout-vflex rt-counter-train" style="transform: translate3d(0px, -100%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    <div class="rt-text-style-h1 counter-color-change">0</div>
                    <div class="rt-text-style-h1 counter-color-change">1</div>
            ...
            <div class="w-layout-vflex rt-achievement-box">
              <div data-w-id="73eb367f-86c6-0ebc-de7f-236ac5f86fdf" class="w-layout-hflex rt-counter rt-overflow-hidden">
                <div class="w-layout-vflex rt-counter-block">
                  <div class="w-layout-vflex rt-counter-train" style="transform: translate3d(0px, -100%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    <div class="rt-text-style-h1 counter-color-change">0</div>
                    <div class="rt-text-style-h1 counter-color-change">1</div>
            ...
            <div class="w-layout-vflex rt-achievement-box rt-border-remove">
              <div data-w-id="73eb367f-86c6-0ebc-de7f-236ac5f8700b" class="w-layout-hflex rt-counter rt-overflow-hidden">
                <div class="w-layout-vflex rt-counter-block rt-margin">
                  <div class="w-layout-vflex rt-counter-train" style="transform: translate3d(0px, -100%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d; will-change: transform;">
                    <div class="rt-text-style-h1 counter-color-change">0</div>
                    <div class="rt-text-style-h1 counter-color-change">1</div>
                    <div class="rt-text-style-h1 counter-color-change">2</div>
                    <div class="rt-text-style-h1 counter-color-change">3</div>
      ...
      <div>
        ...
        <div class="rt-dark-yellow-dot-two"></div>
        <div class="rt-violet-dot"></div>
        <div class="rt-violet-dot-two"></div>
      </div>
    </section>