<section class="rt-imapact-v2">
	<div class="w-layout-blockcontainer rt-container-small w-container">
		<div class="w-layout-hflex rt-imapact-content-v2">
			<div class="w-layout-hflex rt-imapact-image-wrapper-v2">
				<img
					class="rt-imapact-image-v2 rt-autofit rt-tab-full-image"
					src="https://cdn.prod.website-files.com/67a1ea8462c51e3f81e40a7e/6800fb2113073c7667a03435_Group%201009004142.webp"
					width="724"
					height="515"
					alt="Decision"
			...
			<div class="w-layout-vflex rt-imapact-text-wrapper-v2">
				<div class="w-layout-vflex rt-imapact-text-v2">
					<h2 data-w-id="d8cc0c89-5611-467c-7b0c-409b05d85aa5" class="rt-gap-off rt-h2-gap">
						Intelligent Decision-Making Made Easy
					</h2>
				...
				<div
					data-w-id="d8cc0c89-5611-467c-7b0c-409b05d85aaa"
					class="w-layout-vflex rt-impact-innovation-text-wrapper"
				>
					<div class="rt-text-style-h5">Shaping the Future with AI Innovation</div>
				...
				<div class="w-layout-hflex rt-imapact-innovation-box-wrapper">
					<div
						data-w-id="d8cc0c89-5611-467c-7b0c-409b05d85ab0"
						class="w-layout-hflex rt-imapact-innovation-box"
					>
						<div class="w-layout-hflex rt-imapact-icon-block rt-change">
							<img
								width="21"
								height="21"
								alt="Intelligence Icon"
								src="https://cdn.prod.website-files.com/67a1ea8462c51e3f81e40a7e/6805e328ac7691cd07fe8503_Vector%20(3).svg"
								loading="lazy"
								class="rt-autofit"
							/>
						</div>
						<div class="rt-text-style-h5 rt-imapact-innovation-box-text">
							Leading the AI Revolution
						</div>
					</div>
					<div
						data-w-id="d8cc0c89-5611-467c-7b0c-409b05d85ab5"
						class="w-layout-hflex rt-imapact-innovation-box"
					>
						<div class="w-layout-hflex rt-imapact-icon-block rt-change">
							<img
								...
								height="23"
								alt="Intelligence Icon"
								src="https://cdn.prod.website-files.com/67a1ea8462c51e3f81e40a7e/6805e3286ff8c966566c97e0_atom.svg"
								loading="lazy"
								class="rt-autofit"
							/>
						</div>
						<div class="rt-text-style-h5 rt-imapact-innovation-box-text">
							Transforming Life with AI
						</div>
					</div>
				</div>
				<div data-w-id="f11b5c0b-ed3b-23a2-b334-d0ce797f3a50">
					<a
