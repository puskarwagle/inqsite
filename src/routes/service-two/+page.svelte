<script>
	...
	import ServiceOneA from '$lib/components/service-one/ServiceOneA.svelte';
	import ServiceOneB from '$lib/components/service-one/ServiceOneB.svelte';
	import ServiceOneC from '$lib/components/service-one/ServiceOneC.svelte';
	import ServiceOneD from '$lib/components/service-one/ServiceOneD.svelte';
	import ServiceOneE from '$lib/components/service-one/ServiceOneE.svelte';
	import ServiceOneF from '$lib/components/service-one/ServiceOneF.svelte';
