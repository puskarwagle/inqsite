<script>
	...
	import TeamA from '$lib/components/team/TeamA.svelte';
	import TeamB from '$lib/components/team/TeamB.svelte';
	import TeamC from '$lib/components/team/TeamC.svelte';
