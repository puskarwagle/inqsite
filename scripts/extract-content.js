...
`;
	...
	console.log(`   ✓ Generated: ${serverFilePath}`);
}
...
function processComponent(componentPath, componentName, componentFolder) {
	...
	console.log(`   ✓ Extracted ${textCount} texts, ${imageCount} images, ${linkCount} links`);
	...
	console.log(`   ✓ Registered to: ${page || 'SHARED'}`);
...
function main() {
	...
	console.log('🚀 Enhanced Content Extraction Script\n');
